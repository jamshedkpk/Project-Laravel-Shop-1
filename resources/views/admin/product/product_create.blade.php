...
<h4 class="text-center">Welcome To The Product Section</h4>
</div>
</div>
<hr>
<div class="row">
...
<input class="form-control" type="text" name="name" id="name" placeholder="Enter Product Name" value="{{old('name')}}">
@error('name')
...
<input class="form-control" type="text" name="original_price" id="original_price" placeholder="Enter Product Original Price" value="{{old('original_price')}}">
...
<input class="form-control" type="text" name="quantity" id="quantity" placeholder="Enter Product Quantity" value="{{old('quantity')}}">
@error('quantity')
<span class="text-danger">
{{ $message }}
</span>
...
<input class="form-control" type="text" name="slug" id="slug" placeholder="Enter Product slug" value="{{old('slug')}}">
@error('slug')
<span class="text-danger">
{{ $message }}
</span>
